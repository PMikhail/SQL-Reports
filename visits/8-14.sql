select DHS_CUA, visit_status, DIR_LAST_NAME, count(*)
from
(
select nvl(service_group_name, 'No Service') as service_type, case_name, child_id, child_full_nm,
birth_dt, age, age_end_month, number_of_months, adm_name, sup_name, wrk_name, visit_status, dhs_cua, dir_name,
...
group by DHS_CUA, visit_status, DIR_LAST_NAME order by DHS_CUA, DIR_LAST_NAME
--12773
--12664