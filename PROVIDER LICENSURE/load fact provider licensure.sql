...
insert into dhs_core.fact_provider_licensure_etl
     ...
     , dim_document_set_id_noncomplan
     , last_modified_dt
...
select fpl.dim_document_type_id
     , fpl.dim_provider_id
     , fpl.eff_dt
     , fpl.end_dt
...
dhs_core.p_etl.switch_synonyms(v_table_name, 'FACT_PROVIDER_LICENSURE');
