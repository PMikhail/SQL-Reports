...
-----------------------------------------
--test for dim_case_id 151465

select dim_case_id, ref.dim_managing_org_id, completed_dt, dim_work_product_id
...
on final.dim_work_product_id = ref.dim_case_id
...
and dim_work_product_id is null
