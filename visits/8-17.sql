select base.dir_name, base.DIR_LAST_NAME, base.visit_status, base.dim_child_id, count(top.dim_child_id)
from
(
    select distinct dim_worker_id, dwork.last_name as dir_last_name, hier.dim_child_id,
    ...
    dwork.dim_worker_id = hier.director_dim_worker_id
...
(
    ...
    birth_dt, age, age_end_month, number_of_months, adm_name, sup_name, wrk_name, visit_status, dhs_cua, dir_name, dir_worker_id,
    ...
    (
        ...
        to_char(trunc(visits.end_dt), 'mm/dd/yyyy') as last_visit, dwork.last_name as dir_last_name, dwork.dim_worker_id as dir_worker_id,
...
base.dim_child_id = top.dim_child_id
--where visit_status = 'Complete'
group by DHS_CUA, base.dir_name, base.dir_last_name, base.visit_status, base.dim_child_id
order by dhs_cua, case when dir_name like 'CUA%' then dir_name else dir_last_name end
