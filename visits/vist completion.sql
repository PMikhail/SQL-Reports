...
(
    ...
    birth_dt, age, age_end_month, number_of_months, dir_name, adm_name, sup_name, wrk_name,
    nvl(last_visit, 'No Visits') as last_visit, dir_last_name, adm_last_name, sup_last_name, wrk_last_name
    from
    (
...
where child_id = '237959-C'
or child_id = '634896-A'
or child_id = '237959-J';
