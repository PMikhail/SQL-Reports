create table temp_managing_org
( DIM_CASE_ID          INTEGER                  NOT NULL,
  DIM_MANAGING_ORG_ID  INTEGER                  NOT NULL,
  EFF_DT               DATE                     NOT NULL,
  END_DT               DATE                     NOT NULL,
  LAST_MODIFIED_DT     DATE                     NOT NULL
);

describe temp_managing_org

describe fact_case_managing_org
---------------------------------------------------------

insert into temp_managing_org
    ( dim_case_id
    , dim_managing_org_id
    , eff_dt
    , end_dt
...
select * from temp_manage

drop table temp_manage

describe temp_manage
...
insert into fact_case_managing_org
( dim_case_id
, dim_managing_org_id
, eff_dt
, end_dt
...
delete from fact_case_managing_org where dim_case_id is not null

select * from fact_case_managing_org
where dim_case_id = 207186

209491
or dim_case_id = 127432
or dim_case_id = 212319
or dim_case_id = 207186
