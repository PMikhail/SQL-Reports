...
from
(
    select nvl(service_group_name, 'No Service') as service_type, case_name, child_id, child_full_nm, QUEUE_CUA_SHRT_DESC,
    ...
    (
        ...
        awork.full_name as adm_name, awork.last_name as adm_last_name, swork.full_name as sup_name, QUEUE_CUA_SHRT_DESC,
...
--        dcase.dim_case_id = hier.dim_case_id
        ...
        (   /*
            ...
            */
            select atype.dim_assignment_type_id , queue_cd ,assignment_type_cd, QUEUE_CUA_SHRT_DESC                
        ...
        */
            ...
            child_full_nm, age_end_month, child_id
            from 
                (
                ...
                (   /*
                    ...
                    */
                    select brth_dt, child_id, dim_child_id,
